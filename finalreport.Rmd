...
The final part of this analysis sought to spatially visualize this data as to explore possible spatial trends in the data alongside the 
...
ggplot(data=flood_counties_join) +
  ...
  scale_fill_gradientn(colours = colorspace::heat_hcl(7), trans = 'reverse', name = "Total Amount Paid (USD)")+
  labs(
...
ggplot(data=flood_counties_join) +
  ...
  scale_fill_gradientn(colours = colorspace::heat_hcl(7), trans = 'reverse', name = "Total Amount Paid")+
  labs(
