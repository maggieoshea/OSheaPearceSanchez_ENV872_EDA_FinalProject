...
summary.floodpropsall <- Databyyear %>%
  ...
  mutate("Name" = "Number of Properties - All")
...
summary.paidperyear <- Databyyear %>%
  ...
  mutate("Name" = "All Flood Properties Amount Paid")
...
Allsummarystatistics <- rbind(summary.exsitu.amntpaid, summary.exsitu.properties, summary.insitu.properties, summary.insitu.amntpaid, summary.floodpropsall, summary.paidperyear)
```
