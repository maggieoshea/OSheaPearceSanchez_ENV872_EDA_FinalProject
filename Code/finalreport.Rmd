...
1 OpenFEMA Mitigated Properties Dataset Overview...........................6  
\newline
2 North Carolina County Boundaries Dataset Overview..........................7  
\newline
3 Selected Flooding Adaptation Type Codes....................................8   
\newline
4 FEMA Hazard Mitigated Properties Dataset: Summary Statistics..............9    
\newline
5 Results from Time Series Analysis of All Adaptation Types....................18     
\newline
6 Results from Time Series Analysis of Ex-Situ Adaptation......................22     
\newline
5 Results from Time Series Analysis of In-Situ Adaptation.......................26    
\newpage
\listoffigures 
\newpage
...
#install.packages("gtsummary", stringAsFactors = TRUE)
library(gtsummary)
...
finalprojecttheme <- theme_light(base_size = 14) +
  theme(axis.text = element_text(color = "black", size = 9, family = "Times"), 
            legend.position = "right",  
            plot.title = element_text(size=11.5, family = "Times"), 
            plot.subtitle = element_text(size=10, family = "Times"),
...
*Table 3: Selected Flooding Adaptation Type Codes*      
```{r message = FALSE, warning = FALSE, echo = FALSE}
gtobject <- gt(data = typecodes, caption  = "Table 3: Selected Flooding Adaptation Type Codes")
```
...
*Table 4: FEMA Hazard Mitigated Properties Dataset: Summary Statistics*                  
```{r message=FALSE, warning=FALSE, echo=FALSE}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.pos = '!h', fig.cap = "Total Amount Paid for Flooding Adaptation from 1985 - 2020"}
...
ggplot(data = databyyear, aes(x = programFy, y = Floodpropertiesperyear)) +
  geom_bar(stat = "identity", fill = "cornflowerblue")+
  labs( 
    title = "Number of Properties that Received Flood Adaptation Grants: 1985 - 2020", 
    x = "Year", 
    y = "Number of Properties")
```
...
ggplot(databyyear, aes(y= Floodpropertiesperyear, x = programFy)) + 
  ...
  labs(title = "Number of Properties that Received Flood Adaptation Grants: 1985 - 2020", 
       x = "Fiscal Year", 
...
ggplot(inflation_data, aes(y= InflationAdjusted_AllAmountpaid, x = programFy)) + 
  ...
  labs(title = "Inflation Adjusted Total Amount Paid for Flood Adaptation: 1985 - 2020", 
       x = "Year", 
       y= "2020 US Dollars")
```
...
*Table 5: Results from Time Series Analysis of All Adaptation Types*                    
```{r echo=FALSE, message=FALSE, warning=FALSE}
...
ggplot(databyyear, aes(y= Buyouts_propertiesperyear, x = programFy)) + 
  ...
  labs(title = "Number of Properties that Received Funding for Ex-Situ Adaptation: 1985 - 2020", 
  y = "Number of Properties", 
  x = "Year")
```
...
ggplot(databyyear, aes(y= Buyouts_propertiesamountpaid, x = programFy)) + 
  ...
  labs(title = "Total Amount Paid for Ex-Situ Adaptation: 1985 - 2020",
  y = "Amount Paid (USD)", 
  x = "Year") 
```
...
ggplot(inflation_data, aes(y= InflationAdjusted_BUYOUTAmountpaid, x = programFy)) + 
  ...
  labs(title = "Inflation Adjusted Total Amount Paid for Ex-Situ Adaptation: 1985 - 2020",
       x = "Year", 
       y= "2020 US Dollars") 
```

\newpage
A table of the results of all of these three analyses can be found in table 6. 
...
*Table 6: Results from Time Series Analysis of Ex-Situ Adaptation*              
```{r echo=FALSE, message=FALSE, warning=FALSE}
...
ggplot(databyyear, aes(y= insitupropertiesperyear, x = programFy)) + 
  ...
  labs(title = "Number of Properties that Received Funding for In-Situ Adaptation: 1985 - 2020", 
  subtitle = "1985 - 2020", 
  x = "Year", 
  y = "Number of Properties")
```
...
ggplot(databyyear, aes(y= insituproperties_amountpaid, x = programFy)) + 
  ...
  labs(title = "Total Amount Paid for In-Situ Flood Adaptation: 1985 - 2020",
  y = "Amount Paid (USD)", 
  x = "Year")
```
...
ggplot(inflation_data, aes(y= InflationAdjusted_INSITUAmountpaid, x = programFy)) + 
  ...
  labs(title = "Inflation Adjusted Total Amount Paid for In Situ Adaptation: 1985 - 2020",
       x = "Year", 
       y= "2020 US Dollars")
```
...
*Table 7: Results from Time Series Analysis of In-Situ Adaptation*            
```{r echo=FALSE, message=FALSE, warning=FALSE}
...
## Lack of Overall Trends in Flooding Adaptation 
...
## Trends in In-Situ Flooding Adaptation: Spatial and Temporal
