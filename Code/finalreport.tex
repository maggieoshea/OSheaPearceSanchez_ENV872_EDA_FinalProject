...
\newline
2 North Carolina County Boundaries Dataset
Overview\ldots\ldots\ldots\ldots\ldots\ldots\ldots\ldots..7\\
\newline
3 Selected Flooding Adaptation Type
Codes\ldots\ldots\ldots\ldots\ldots\ldots\ldots\ldots\ldots\ldots\ldots\ldots8\\
\newline
4 FEMA Hazard Mitigated Properties Dataset: Summary
Statistics\ldots\ldots\ldots\ldots..9\\
\newline
5 Results from Time Series Analysis of All Adaptation
Types\ldots\ldots\ldots\ldots\ldots\ldots..18\\
\newline
6 Results from Time Series Analysis of Ex-Situ
Adaptation\ldots\ldots\ldots\ldots\ldots\ldots\ldots.22\\
\newline
5 Results from Time Series Analysis of In-Situ
