...
floodproperties_amountpaid <- hazardprops %>%
...
#Ex situ
buyoutfloodproperties_amountpaid <- hazardprops %>%
...
#In situ
insitufloodproperties_amountpaid <- hazardprops %>%
...
ggplot(floodproperties_amountpaid, aes(y= Floodpropertiesperyear, x = programFy)) + 
  geom_line() +
