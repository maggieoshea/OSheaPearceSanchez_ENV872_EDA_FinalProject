...
\caption{Figure 1: Total Properties that Received Flood Adaptation
Funding from 1985 to 2020}
\end{figure}
...
\caption{Figure 2: Total Amount Paid for Flooding Adaptation from 1985 -
2020}
\end{figure}
...
\caption{Figure 3: Number of Properties that Received Flood Adaptation
Grants from 1985 - 2020}
\end{figure}
...
\caption{Figure 4: Total Amount Paid for Flood Adaptation Grants from
1985 to 2020 in 2020 inflation adjusted U.S. dollars}
\end{figure}
...
number of properties that receive grant funding over time? * Total
Amount Paid for All Adaptation: Is there a monotonic trend in the total
amount paid for flooding adaptation grants over time? * Total Amount
Paid - Inflation Adjusted: Is there (still) a monotonic trend in the
total amount paid for flooding adaptation grants over time when
...
properties that received ex-situ grant funding, or funding to buyout the
property, over time? * Amount Paid for Buyouts: Is there a monotonic
trend in the amount paid for buyouts over time? * Amount Paid for
Buyouts - Inflation Adjusted: Is there (still) a monotonic trend in the
amount paid for buyouts after adjusting for inflation to 2020 dollars?
...
place over time? * Amount Paid for In-Situ Adaptation: Is there a
monotonic trend in the amount paid for in-situ adaptation over time? *
...
\caption{Figure 5: Number of Properties that Received Flood Adaptation
Grants between 1985 and 2020}
\end{figure}
...
\caption{Figure 6: Total Amount Paid for Flood Adaptation between 1985
and 2020}
\end{figure}
...
\caption{Figure 7: Total Amount Paid for Flood Adaptation between 1985
and 2020: 2020 Inflation Adjusted U.S. Dollars}
\end{figure}
...
\includegraphics{finalreport_files/figure-latex/fig.cap:"Figure8:NumberofPropertiesthatReceivedFundingforEx-SituAdaptationtoFloodingbetween1985and2020"-1.pdf}

The statistically significant monotonic trend in the total amount paid
for buyouts (p = 0.003) can be found in figure 9.

\includegraphics{finalreport_files/figure-latex/fig.cap:"Figure9:TotalAmountPaidforEx-SituAdaptationtoFloodingbetween1985and2020"-1.pdf}
...
\includegraphics{finalreport_files/figure-latex/fig.cap:"Figure10:TotalAmountPaidforEx-SituAdaptationtoFloodingbetween1985and2020in2020InflationAdjustedU.S.Dollars."-1.pdf}
...
\includegraphics{finalreport_files/figure-latex/fig.cap:"Figure11:NumberofPropertiesthatReceivedGrantFundingforIn-SituAdaptationtoFloodingbetween1985and2020."-1.pdf}
...
\includegraphics{finalreport_files/figure-latex/fig.cap:"Figure12:TotalAmountPaidforIn-SituAdaptationtoFloodingbetween1985and2020."-1.pdf}

\includegraphics{finalreport_files/figure-latex/fig.cap:"Figure13:TotalAmountPaidforIn-SituAdaptationtoFloodingbetween1985and2020in2020InflationAdjustedU.S.Dollars."-1.pdf}
...
\caption{Map 1: Spatial Distribution of the Number of Properties that
Received Flooding Adaptation Grant Funding between 1985 - 2020}
\end{figure}
...
\caption{Map 2: Spatial Distribution of the Number of Properties that
Received In-Situ Flooding Adaptation Grant Funding between 1985 - 2020}
\end{figure}

\begin{figure}
\centering
\includegraphics{finalreport_files/figure-latex/unnamed-chunk-20-1.pdf}
\caption{Map 3: Spatial Distribution of the Number of Properties that
Received Ex-Situ Flooding Adaptation Grant Funding between 1985 - 2020}
\end{figure}
